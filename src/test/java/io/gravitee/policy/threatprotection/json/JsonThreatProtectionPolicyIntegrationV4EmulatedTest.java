...
public class JsonThreatProtectionPolicyIntegrationV4EmulatedTest {

    @Nested
    @GatewayTest(v2ExecutionMode = ExecutionMode.V4_EMULATION_ENGINE)
    @DeployApi({ "/apis/defaultV4Emulated.json" })
    ...
    @Nested
    @GatewayTest(v2ExecutionMode = ExecutionMode.V4_EMULATION_ENGINE)
    @DeployApi({ "/apis/defaultV4Emulated-accept-duplicate-keys.json" })
