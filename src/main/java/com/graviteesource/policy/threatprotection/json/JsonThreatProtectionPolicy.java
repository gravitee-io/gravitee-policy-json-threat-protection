...
import com.graviteesource.policy.threatprotection.json.deployer.JsonThreatProtectionPolicyDeploymentLifecycle;
 ...
 */
@Plugin(deployment = JsonThreatProtectionPolicyDeploymentLifecycle.class)
